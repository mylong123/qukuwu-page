...
$(document).ready(function(){
    ...
    $(".sitenav a").each(function(i) {
    	$this = $(this);
    	//获取栏目
    	var durl = String(window.location).split('/')[3];
    	var nurl = $this[0].href.split('/')[3];        
    ...
    // ROLLBAR
	TBUI.bd.append('<div class="rollbar">'+ (is_page('comment-open') ? '' : '') +'<div class="rollbar-item" etap="to_top"><i class="fa">&#xe604;</i></div></div>')
